...
public class Aluno extends Pessoa {
    ...
    public Aluno(String nome, String endereco, String telefone, String cpf, String telefoneCelular, String nomeCurso, double[] notas) {
    ...
    public void verificarAcesso() {
        this.nomeVisibilidade = "Teste de Acesso Protected";

        System.out.println(nomeVisibilidade);
    }
}
